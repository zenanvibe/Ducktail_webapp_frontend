...
const fields = [
  ...
  { label: "Years of Establishment", value: "Enter Years of Establishment" },
  ...
  { label: "Engineer Name", value: "Enter Engineer Name" },
  { label: "Number of Courses", value: "Enter Number of Courses" },
