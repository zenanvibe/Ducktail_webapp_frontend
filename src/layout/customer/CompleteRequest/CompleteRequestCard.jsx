...
const CompleteRequestCard = () => {
  ...
  useEffect(() => {
    console.log("Fetching completion request projects...");
        ...
        >
          ...
          <div className="bg-white rounded-3xl p-6 relative lg:w-2/5 shadow-lg overflow-hidden">
            ...
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2">{project.builder_company || "Unknown Builder"}</h2>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div className="text-gray-600">{project.status || "N/A"}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-gray-600">{project.project_location || "N/A"}</div>
              </div>
            </div>
          </div>
