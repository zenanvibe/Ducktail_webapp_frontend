...
const CompletedCard = () => {
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row gap-6 max-w-4xl mx-auto p-6 transition-all duration-300 ${
        showDocuments ? "lg:max-w-5xl" : "lg:max-w-4xl"
      }`}
    >
      {/* Left Section - Project Details */}
      <div className="bg-white rounded-3xl p-6 relative max-w-md shadow-lg overflow-hidden flex-1 h-[320px] overflow-y-auto">
...
<div className="relative flex items-center justify-center mb-4 pb-2 border-b border-black">
  ...
  <div className="absolute right-0 flex gap-2">
    ...
    <button className="h-8 w-8 flex items-center justify-center rounded-full border border-gray-400 shadow-md">
      ...
      <div
        className={`bg-white p-6 rounded-2xl shadow-lg flex-1 transition-all duration-300 ${
          showDocuments ? "block" : "hidden"
        }`}
      >
